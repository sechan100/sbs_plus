...
public class ArticleServiceImpl implements ArticleService {
    ...
    @Override
    public List<ArticleDto> findTop10() {
        List<Article> top10Articles = articleRepository.findTop10ByOrderByCreateAtDesc();
        return top10Articles.stream()
                .map(article -> (new ModelMapper()).map(article, ArticleDto.class))
